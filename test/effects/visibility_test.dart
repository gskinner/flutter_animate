...
void main() {
  testWidgets('visibility test, maintain = true', (tester) async {
    ...
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainAnimation, true, 'maintainSize');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainInteractivity, true, 'maintainInteractivity');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainSemantics, true, 'maintainSemantics');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainSize, true, 'maintainSize');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainState, true, 'maintainState');
  ...
  testWidgets('visibility test, maintain = false', (tester) async {
    ...
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainInteractivity, false, 'maintainInteractivity');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainSemantics, false, 'maintainSemantics');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainSize, false, 'maintainSize');
    tester.expectWidgetWithBool<Visibility>((ft) => ft.maintainState, false, 'maintainState');
  });
}
